...
sudo nex bash run_within_nex_10.sh ./hyperprotobench/nex/binaries/bench1.x86  > $output/bench1-rtl.txt
...
sudo nex bash run_within_nex_10.sh ./hyperprotobench/nex/binaries/bench1.x86 > $output/bench1-dsim.txt
...
# sudo nex bash run_within_nex_10.sh ./hyperprotobench/nex/binaries/bench1.x86 > $output/bench1-legacy-dsim.txt
