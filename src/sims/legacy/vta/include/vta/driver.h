 ...
 */
int AccVMVTADeviceRun(VTADeviceHandle device,
 ...
 */
vta_phy_addr_t AccVMVTAMemGetPhyAddr(void* buf);
 ...
 * \param size Size of the region in Bytes.
 */
void AccVMVTAMemCopyFromHost(void* dst, const void* src, size_t size);
 ...
 * \param size Size of the region in Bytes.
 */
void AccVMVTAMemCopyToHost(void* dst, const void* src, size_t size);
 ...
 */
void AccVMVTAFlushCache(void* vir_addr, vta_phy_addr_t phy_addr, int size);
 ...
 */
void AccVMVTAInvalidateCache(void* vir_addr, vta_phy_addr_t phy_addr, int size);
